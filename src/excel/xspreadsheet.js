...
window._excel_viewer_languages = {
	...
	zh_cn: {
		...
		sort: { desc: "按 Z -> A 排序", asc: "按 A -> Z 排序" },
		filter: { empty: "空" },
		dataValidation: {
			mode: "模式",
			range: "单元格范围",
			criteria: "标准",
			modeType: { cell: "单元格", column: "列", row: "行" },
			type: {
				list: "列表",
				number: "数值",
				date: "日期",
	...
	function (t, e, n) {
				...
				(function (t, e) {
					...
					try {
						for (
							...
							!(r = (a = l.next()).done) && (n.push(a.value), !e || n.length !== e);
							r = !0
						);
					} catch (t) {
						(i = !0), (o = t);
		...
		var R = function t() {
			for (
				...
				r[i - 1] = arguments[i];
			let isDark = /dark/.test(document.documentElement.getAttribute("data-excel-viewer-theme"));
			return (
				r.forEach(function (n) {
					if (!n) return;
					if (n.border) {
						Object.keys(n.border).forEach(i => n.border[i][1] = isDark ? "#fff" : "#000");
					}
		...
		var W = (function () {
			...
			V = "en",
			q = window._excel_viewer_languages;
		function B(t, e) {
			V = document.documentElement.getAttribute("data-excel-viewer-lang") || "zh_cn";
			if (e && e[V])
		...
		var Z = { phone: /^[1-9]\d{10}$/, email: /w+([-+.]w+)*@w+([-.]w+)*.w+([-.]w+)*/ };
		function K(t, e) {
			var n = "";
			if (!t) {
		...
		var lt = {
			...
			style: {
				bgcolor: "#fff", // 非空单元格背景颜色
				align: "left",
				valign: "middle",
				textwrap: !1,
				strike: !1,
				underline: !1,
				color: "#0a0a0a", // 单元格文字颜色
				...
				(n = [
					...
					},
					{
						...
						value: function () {
							...
							for (
								var p = a;
								p < n.len && ((f = p), !((l += n.getWidth(p)) > this.viewWidth()));
								p += 1
							);
		...
		function yt(t) {
			t.xclickoutside &&
				(dt(window.document.body, "click", t.xclickoutside), delete t.xclickoutside);
		}
		function vt(t, e) {
				...
				function t() {
					...
					xt(this, t),
						...
						(this.areaEl = a("div", "".concat(mt, "-selector-area"))
							.child(this.cornerEl)
							.hide()),
						(this.clipboardEl = a("div", "".concat(mt, "-selector-clipboard")).hide()),
						(this.autofillEl = a("div", "".concat(mt, "-selector-autofill")).hide()),
						(this.el = a("div", "".concat(mt, "-selector"))
							.css("z-index", "".concat(_t))
							.children(this.areaEl, this.clipboardEl, this.autofillEl)
							.hide()),
						n &&
							((this.hideInput = a("input", "").on("compositionend", function (t) {
								e.inputChange(t.target.value);
							})),
							this.el.child(
								(this.hideInputDiv = a("div", "hide-input").child(this.hideInput))
							),
							this.el.child(
								(this.hideInputDiv = a("div", "hide-input").child(this.hideInput))
							)),
		...
		var Lt = (function () {
			function t(e, n) {
				...
				!(function (t, e) {
					...
					(this.filterItems = []),
					(this.items = e),
					(this.el = a("div", "".concat(mt, "-suggest")).css("width", r).hide()),
					(this.itemClick = n),
					(this.itemIndex = -1);
			}
			var e, n, r;
		...
		var Kt = (function (t) {
			function e(t) {
				...
				return (
					...
					((n = $t(this, Xt(e).call(this, "div", "".concat(mt, "-icon")))).iconNameEl = a(
						"div",
						"".concat(mt, "-icon-img ").concat(t)
					)),
		...
		function ae() {
			...
			if (!/^\s*$/.test(t)) {
				...
				if (l > r.width) {
					var u = l;
					l > c && ((u = c), (s += parseInt(l / c, 10)), (s += l % c > 0 ? 1 : 0)),
		...
		var se = (function () {
			function t(e, n, r) {
				...
				!(function (t, e) {
					...
					(this.el = a("div", "".concat(mt, "-editor")).child(this.areaEl).hide()),
		...
		function Ee(t, e, n, r, i, o, a) {
			...
			"underline" === t
				...
				: "strike" === t &&
				  ("bottom" === i ? (l.y = o / 2) : "top" === i && (l.y = -(o / 2 + 2))),
				...
				return (
					me(t, [
						...
						},
						{
							...
							value: function (t, e, n, r) {
								return (
									this.ctx.fillRect(Oe(t) - 0.5, Oe(e) - 0.5, Oe(n), Oe(r)), this
								);
							}
						},
						{
			...
			Re = function (t, e, n, r) {
				for (var i = [], o = 0; o < t.length; o += 1) {
					...
					if ("+" === a) {
						...
						for (var y = Te(a, 2), v = y[0], b = y[1], g = [], m = 0; m < b; m += 1)
							g.push(i.pop());
		...
		var qe = function (t) {
			...
			Le = [
				{ key: "normal", title: U("format.normal"), type: "string", render: qe },
		...
		var Xe = 5,
			Ze = { fillStyle: "#f4f5f8" }, // 行列头背景颜色
			Ke = { fillStyle: "#fff", lineWidth: ke, strokeStyle: "#e6e6e6" }; // 单元格默认边框颜色
		function Je(t, e, n) {
		...
		function tn(t, e, n, r) {
			var i = this.draw;
			i.save(),
				i.attr({ fillStyle: "rgba(75, 137, 255, 0.1)" }).fillRect(t, e, n, r),
				i.restore();
		}
		function en(t, e, n, r, i, o) {
			...
			l.attr({
				...
				fillStyle: isDark ? "#9e9e9e" : "#585757", // 行列头文字颜色
				lineWidth: ke(),
				strokeStyle: isDark ? "#373737" : "#e6e6e6" // 行列头边框颜色
			}),
				("all" !== t && "left" !== t) ||
						...
						value: function () {
							...
							nn.call(this, i, n, r, o, a),
								...
								function (t, e) {
									var n = this.draw;
									n.save(),
										n.attr({ fillStyle: isDark ? "#1f1f1f" : "#f4f5f8" }).fillRect(0, 0, t, e), // 左上角第一个背景颜色
										n.restore();
								}.call(this, n, r);
							var u = Ye(t.freeze, 2),
								f = u[0],
								...
								nn.call(this, y, n, r, 0, 0),
									...
									function (t, e, n, r) {
										...
										i
											.save()
											.translate(t, e)
											.attr({ strokeStyle: "rgba(51, 113, 255, .6)" }),
											i.line([0, r], [a, r]),
											i.line([n, 0], [n, l]),
											i.restore();
									}.call(this, n, r, o, a);
		...
		var dn = [
			...
			{ key: "paste-value", title: U("contextmenu.pasteValue"), label: "Ctrl+Shift+V" },
			{ key: "paste-format", title: U("contextmenu.pasteFormat"), label: "Ctrl+Alt+V" },
			{ key: "divider" },
				...
				(n = [
					{
						key: "element",
						value: function () {
							if (count++ == 0 && window._excel_viewer_theme_btn === true) {
								let lang = document.documentElement.getAttribute("data-excel-viewer-lang") || "zh_cn";
								let isDark = /dark/.test(document.documentElement.getAttribute("data-excel-viewer-theme"));
								window._excel_viewer_theme_btn = document.createElement("div");
								window._excel_viewer_theme_btn.setAttribute("data-tooltip", window._excel_viewer_languages[lang].themeModeTips[isDark ? "light" : "dark"]);
								window._excel_viewer_theme_btn.className = "x-spreadsheet-toolbar-btn theme-mode";
								window._excel_viewer_theme_btn.innerHTML = `
								...
								window._excel_viewer_theme_btn.addEventListener("click", () => {
									let mode = document.documentElement.getAttribute("data-excel-viewer-theme");
									if (/dark/.test(mode)) {
										document.documentElement.setAttribute("data-excel-viewer-theme", "light");
										window._excel_viewer_theme_btn.setAttribute("data-tooltip", window._excel_viewer_languages[lang].themeModeTips.dark);
									} else {
										document.documentElement.setAttribute("data-excel-viewer-theme", "dark");
										window._excel_viewer_theme_btn.setAttribute("data-tooltip", window._excel_viewer_languages[lang].themeModeTips.light);
									}
								})
								window._excel_viewer_theme_btn.addEventListener("mouseenter", e => {
									!(function (t, e) {
										if (!e.classList.contains("active")) {
											var n = e.getBoundingClientRect(),
												...
												o = n.width,
												l = n.height,
												c = a("div", "".concat(mt, "-tooltip"))
													.html(t)
													.show();
											document.body.appendChild(c.el);
											window._excel_viewer_theme_mode_tips_el = c.el;
											var s = c.box();
											c
												.css(
													"left",
													"".concat(r + o / 2 - s.width / 2, "px")
												)
												.css("top", "".concat(i + l + 8, "px")),
												pt(e, "mouseleave", function () {
													document.body.contains(c.el) &&
														document.body.removeChild(c.el);
												}),
												pt(e, "click", function () {
													c.el.innerText = window._excel_viewer_theme_btn.getAttribute("data-tooltip")
												});
										}
									})(window._excel_viewer_theme_btn.getAttribute("data-tooltip"), e.target);
								});
							}
							var t = this.tip;
			...
			function e(t, n, r, i) {
				...
				!(function (t, e) {
					...
					(l.contentEl = a("div", "".concat(mt, "-dropdown-content"))
						.css("width", n)
						.hide());
				for (var c = arguments.length, s = new Array(c > 4 ? c - 4 : 0), u = 4; u < c; u++)
					s[u - 4] = arguments[u];
				return (
			...
			function e(t, n) {
				...
				var o = new Kt("align-".concat(n)),
					l = t.map(function (t) {
						...
						a("div", "".concat(mt, "-item")).child(new Kt(e))).on("click", function () {
				...
				return (i = zn(
					this,
					(r = Hn(e)).call.apply(r, [this, o, "auto", !0, "bottom-left"].concat(In(l)))
				));
			}
			var n, r, i;
			return (
		...
		var sr = (function (t) {
			...
			return (
				...
				(n = e),
				(r = [{ key: "setState", value: function () {} }]) && or(n.prototype, r),
				i && or(n, i),
				e
			);
		})();
		...
		var zr = function t() {
			...
			var o = a("table", "").children(
				(e = a("tbody", "")).children.apply(
					e,
					[
						(n = a("tr", "".concat(mt, "-theme-color-placeholders"))).children.apply(
							n,
							Pr(
								Ar.map(function (t) {
									return Dr.call(i, t);
						...
						Pr(
							Rr.map(function (t) {
								var e;
								return (e = a("tr", "".concat(mt, "-theme-colors"))).children.apply(
									e,
									Pr(
										t.map(function (t) {
											return Dr.call(i, t);
				...
				function e(t) {
					...
					var i = new Kt("line-type"),
						...
						l = $r.map(function (e, n) {
							return a(
								"div",
								"".concat(mt, "-item state ").concat(t === e[0] ? "checked" : "")
							)
								.on("click", function () {
									l[o].toggle("checked"),
										l[n].toggle("checked"),
		...
		var Qr = function t() {
			...
			!(function (t, e) {
				...
				(this.color = isDark ? "#fff" : "#000"), // 单元格边框线颜色
				(this.style = "thin"),
				(this.mode = "all"),
				(this.change = function () {}),
		...
		var Ci = (function (t) {
			...
			return (
				...
				(n = e),
				(r = [{ key: "setState", value: function () {} }]) && xi(n.prototype, r),
				i && xi(n, i),
				e
			);
		})();
		...
		var Yi = (function (t) {
			function e() {
				...
				return (n = Bi(
					this,
					(t = Li(e)).call.apply(t, [this, "10", "60px", !0, "bottom-left"].concat(qi(r)))
				));
			}
			return (
				(function (t, e) {
						  ...
						  setTimeout(function () {
								(function () {
									...
									(this.btns2 = []),
										...
										if (typeof window._excel_viewer_theme_btn == "object") {
											let container = document.querySelector(".x-spreadsheet-toolbar");
											container.appendChild(window._excel_viewer_theme_btn);
										}
								}.call(r),
									ja.call(r));
						  }, 0),
				...
				!(function (t, e) {
					...
					(this.el = a("div", "".concat(mt, "-modal"))
						...
						.children(
							...
							(r = a("div", "".concat(mt, "-modal-content"))).children.apply(r, Ca(n))
						)
						.hide());
			}
			var e, n, r;
		...
		var Ha = { number: /(^\d+$)|(^\d+(\.\d{0,4})?$)/, date: /^\d{4}-\d{1,2}-\d{1,2}$/ },
			Ma = (function () {
				function t(e, n, r, i) {
					var o = this;
					!(function (t, e) {
		...
		function Qa(t, e) {
			var n,
				r = this;
			return function () {
				for (var i = r, o = arguments.length, a = new Array(o), l = 0; l < o; l++)
					a[l] = arguments[l];
				var c = a;
				n ||
					...
					function () {
						c &&
							...
							function () {
								var t = this.toolbar;
								t.paintformatActive() &&
									(cl.call(this, "format"), ol.call(this), t.paintformatToggle());
							}.call(e);
					}
				)),
		...
		var bl = (function () {
			function t(e, n) {
				...
				(this.el = a("div", "".concat(mt, "-sheet"))),
					...
					(this.overlayerCEl = a("div", "".concat(mt, "-overlayer-content")).children(
						this.editor.el,
						this.selector.el
					)),
		...
		var _l = (function (t) {
				function e(t) {
					...
					return (
						((n = xl(this, El(e).call(this, r, "auto", !1, "top-left"))).contentClick =
							t),
						n
					);
				}
		...
		var Dl = (function () {
				function t(e) {
					let isDark = /dark/.test(document.documentElement.getAttribute("data-excel-viewer-theme"));
					if (isDark) {
						lt.style.bgcolor = "#0a0a0a";
						lt.style.color = "#fff"
						Ze.fillStyle = "#1f1f1f";
						Ke.strokeStyle = "#212121";
					} else {
						lt.style.bgcolor = "#fff";
						lt.style.color = "#000";
						Ze.fillStyle = "#f4f5f8";
						Ke.strokeStyle = "#e6e6e6";
					}
					var n = this,
						r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
					!(function (t, e) {
