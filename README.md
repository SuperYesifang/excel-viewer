...
![excel-viewer](https://img.shields.io/badge/excel--viewer-v0.0.2-%23C50008?logo=npm)
...
```js
new ExcelViewer("#excel-view", "http://example.com/test.xls", { theme: "dark", lang: "zh_cn" });
```
