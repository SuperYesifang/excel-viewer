...
![excel-viewer](https://img.shields.io/badge/excel--viewer-v1.0.0-%23C50008?logo=npm)
...
If you need to use multiple excel-viewer on one page, you will not be able to use ESM way, but can use the iframe embedded way.
